...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CLT tecnico = new CLT("Gabriel",40,"Técnico");
        PJ funcionario = new PJ("Izabella", 220);
            ...
            case 'S':
                ...
                switch(opcao){
                    ...
                    case '1':
                        ...
                        System.out.println(funcionario.pagamento(horaTrab));
                        break;
                    ...
                    case '2':
                        ...
                        System.out.println("Pagamento de salario efetifado: CLT"+tecnico.pagamento(resposta));
                        break;
